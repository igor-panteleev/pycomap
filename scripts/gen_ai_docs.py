"""Generate llms.txt and CLAUDE.md from README.md.

README.md is the single source of truth for project + API documentation.
llms.txt  = README verbatim (LLM-readable project reference).
CLAUDE.md = Claude Code workflow rules prepended to README.
"""
...
def main() -> None:
    ...
    llms = ROOT / "llms.txt"
    llms.write_text(readme)
    print(f"wrote {llms.relative_to(ROOT)}")

    claude = ROOT / "CLAUDE.md"
    claude.write_text(_CLAUDE_PREAMBLE + readme)
